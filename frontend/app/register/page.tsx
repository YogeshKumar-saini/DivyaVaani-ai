            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className={`h-11 rounded-xl bg-white/5 border-white/10 text-white placeholder:text-white/20 focus:bg-white/8 transition-all ${confirmPassword && password !== confirmPassword
